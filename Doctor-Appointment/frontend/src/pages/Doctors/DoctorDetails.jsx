...
import doctorImg from '../../assests/images/doctor-img02.png'
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="">
              ...
              <p className="text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur delectus saepe ut odit sequi doloremque praesentium dicta, porro veniam fuga.
              </p>
            </div>
          </div>
